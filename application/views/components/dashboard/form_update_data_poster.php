...
<?php 
    ...
    $posterID = $data;
    $result = $this->posterModel->getDataPosterID($posterID); 
    foreach($result as $db_result):
?>

<form id="poster_editform" action="<?php echo BASEURL;?>/editPoster/updateDataPoster" method="post" enctype="multipart/form-data">
    <input type="hidden" name="hiddenID" value="<?php echo $db_result->posterID; ?>" />
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <input type="file" name="file_poster" id="file_poster" class="dropify"
                        data-default-file="./assets/poster/<?php echo $db_result->file_poster; ?>" />
                </div>
            </div>
            <!-- fix -->
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <label class="custom-switch">
                        <input type="checkbox" name="display_poster" value="1" class="custom-switch-input" <?php 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_poster" id="name_poster"
                                    placeholder="ชื่อโปสเตอร์" value="<?php echo $db_result->name_poster; ?>">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control" name="dateail_poster" id="dateail_poster"
