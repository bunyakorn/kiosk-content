...
<div class="bg-white p-3 header-secondary row">
    ...
    <div class="col col-auto">
        <a class="btn btn-light mt-4 mt-sm-0" href="<?php echo BASEURL; ?>/profileAccount">
...
if ($dstatus == "admin") {
    //onClick="onSubmit()"
    ?>
        <a class="btn btn-success mt-4 mt-sm-0" id="btn-adduser" data-toggle="modal" data-target="#formAddDataUser">
