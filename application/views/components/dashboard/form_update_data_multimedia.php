...
<link rel="stylesheet" href="./assets/plugins/fileuploads/css/dropify.css" type="text/css">
<?php 
    
   
    $mediaID = $data;
    $results = $this->mediaModel->getdataMediaID($mediaID);
    foreach($results as $db_result):
?>
<?php ?>
<form id="multimedia_editform" action="<?php echo BASEURL;?>/editMultimedia/updateDataMultimedia" method="post" enctype="multipart/form-data">
    <input type="hidden" name="hiddenID" value="<?php echo $db_result->multimediaID; ?>" />
    <input type="hidden" name="uploadby" value="<?php echo $datauser->department;?>"/>
    <div class="row">
        <div class="col-xl-4 col-lg-12 col-md-12">
            <div class="card shadow">
                <div class="card-header">
                    <h3 class="mb-0 card-title">อัพโหลดไฟล์วิดีโอ (File WEBM/MP4)</h3>
                </div>
                <div class="card-body">
                    <input type="file" name="file_video" id="file_video" class="dropify"
                        data-default-file="./assets/multimedia/<?php echo $db_result->file_video; ?>" />
                </div>
                <input type="hidden" name="hdfile" value="<?php echo $db_result->file_video; ?>">
            </div>
            <!-- fix -->
            <div class="card shadow">
                <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <label class="custom-switch">
                        <input type="checkbox" name="display_multimedia" value="1" class="custom-switch-input" <?php 
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 card-title">
                        ...
                        ข้อมูล
                        รายละเอียดต่าง ๆ เกี่ยวกับเกี่ยวกับมัลติมีเดีย</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_multimedia" id="name_multimedia"
                                    placeholder="ชื่อมัลติมีเดีย..." value="<?php echo $db_result->name_multimedia; ?>">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control" name="dateail_multimedia" id="dateail_multimedia"
