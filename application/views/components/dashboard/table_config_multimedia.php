...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form id="multimedia_updatelevel" action="<?php echo BASEURL; ?>/configMultimedia/updateConfig" method="post">
                        ...
                        <tbody>
                            <?php foreach ($data[2] as $row) { ?>
                                ...
                                <tr>
                                    <th scope="row">
                                        <?php echo $i; ?>
                                        <input type="hidden" name="hdnmultimediaID<?php echo $i; ?>" value="<?php echo $row->multimediaID; ?>">
                                    </th>
                                    <td>
                                        <?php
                                    ...
                                    <td class="text-center">
                                        <input type="text" name="shownumber<?php echo $i; ?>" class="textnumber" id="shownumber<?php echo $i; ?>" value="<?php echo $row->shownumber; ?>" maxlength="2">
                                    </td>
                                    <td>
                                        <a class="btn btn-sm btn-info" id="<?php echo $row->multimediaID; ?>" href="javaScript:void(0);" onclick="viewMultimedia(this.id)">
        ...
        <div class="modal-content ">
            <div class="modal-header pd-x-20">
                <h3 class="modal-title text-info">
                    ...
                    <span> แสดงข้อมูลวิดีโอมัลติมีเดีย ประชาสัมพันธ์ </span>
                </h3>
