    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">ตารางแสดงรายการ ข้อความวิ่ง</h3>
                <div class="card-options"></div>
            </div>
            <form id="hotnews_updatelevel" action="<?php echo BASEURL;?>/configHotnews/updateConfig" method="post">
                    ...
                    <table
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="border-top-0">ข้อมูลการแสดงผล ข้อความวิ่ง</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <?php echo $i;?>
                                    <input type="hidden" name="hdnhotnewsID<?php echo $i;?>"
                                        value="<?php echo $row->hnid;?>">
                                </th>
                                <td>
                                <?php 
