    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header ">
                <h3 class="card-title ">ตารางแสดงรายการข้อมูลมัลติมีเดีย ที่ผ่านมา</h3>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-info" id="<?php echo $row->multimediaID;?>"
                                    ...
                                    <i class="fa fa-info-circle"></i> ดูข้อมูล
                                </a>
                            </td>
                        </tr>
                        <?php } ?>
...
<script>
    function viewmultimedia(dataID) {    
        ...
        var url = '<?php echo BASEURL; ?>/multimedia/detailMedia?searchData=' + searchValue;
        if(searchValue !== ''){
