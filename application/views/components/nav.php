<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">MVCFramework</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor03">
        <ul class="navbar-nav mr-auto">
            ...
            <?php else : ?>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo BASEURL;?>/profile/productForm">Add Products</a>
            </li>
            <?php endif; ?>
        </ul>
        <?php if($this->getSession('userId')): ?>
        <ul class="my-2 my-lg-0">
            <a href="<?php echo BASEURL;?>/profile/logout" class="btn btn-success">Logout</a>
        </ul>
        <?php endif; ?>
    </div>
</nav>
